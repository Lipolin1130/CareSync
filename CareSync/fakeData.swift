...
func getMedicalRecords() -> [MedicalRecord] {
    ...
    let medicalRecords: [MedicalRecord] = [
        MedicalRecord(person: persons[0], yearMonthDay: YearMonthDay(year: 2024, month: 6, day: 15), hospitalName: "City Hospital", hospitalLocation: "City Center", symptomDescription: "Fever and cough", doctorOrder: "Rest and hydration", appointment: true),
        ...
        MedicalRecord(person: persons[2], yearMonthDay: YearMonthDay(year: 2024, month: 6, day: 20), hospitalName: "General Hospital", hospitalLocation: "North Area", symptomDescription: "Stomach ache", doctorOrder: "Antacids", appointment: true),
        MedicalRecord(person: persons[3], yearMonthDay: YearMonthDay(year: 2024, month: 6, day: 5), hospitalName: "District Hospital", hospitalLocation: "South End", symptomDescription: "Back pain", doctorOrder: "Physiotherapy", appointment: true),
        ...
        MedicalRecord(person: persons[1], yearMonthDay: YearMonthDay(year: 2024, month: 7, day: 15), hospitalName: "County Hospital", hospitalLocation: "East Side", symptomDescription: "High blood pressure", doctorOrder: "Lifestyle changes", appointment: true),
        MedicalRecord(person: persons[2], yearMonthDay: YearMonthDay(year: 2024, month: 7, day: 5), hospitalName: "General Hospital", hospitalLocation: "North Area", symptomDescription: "Allergic reaction", doctorOrder: "Antihistamines", appointment: true),
        ...
        MedicalRecord(person: persons[1], yearMonthDay: YearMonthDay(year: 2024, month: 6, day: 8), hospitalName: "County Hospital", hospitalLocation: "East Side", symptomDescription: "Migraine", doctorOrder: "Pain relief", appointment: true)
    ]
